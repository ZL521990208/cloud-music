  ...
  <div>
    <v-card class="overflow-hidden">
      ...
      >
        ...
        <v-app-bar-nav-icon>云音乐后台</v-app-bar-nav-icon>
    ...
    <v-container class="box">
      <v-row>
        <v-col cols="3">
          <v-container>
            <v-card min-height="700" class="overflow-hidden">
              <v-navigation-drawer
                v-model="drawer"
                :color="color"
                  ...
                  <v-list-item two-line :class="miniVariant && 'px-0'">
                    <v-list-item-avatar>
                      <img
                        ...
                        src="http://ww1.sinaimg.cn/large/0064QvQTly1ge0apt4bokj30qn0qnwfa.jpg"
                      />
                    </v-list-item-avatar>
                    ...
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle class="gutter"
